...
public class TwitterUserServicesImpl implements UsersResources {
    /**
     * Logger for this services
     */
    private static Logger LOGGER = LogManager.getLogger(TwitterUserServicesImpl.class.getName());
    /**
     * Twitter instance
     */
    @Autowired
    ...
    public ResponseList<User> lookupUsers(String... screenNames) throws TwitterException {
        ResponseList<User> userList = twitter.lookupUsers(screenNames);
        return userList;
    }
