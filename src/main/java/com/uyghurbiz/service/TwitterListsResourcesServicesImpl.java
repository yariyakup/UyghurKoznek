 ...
 */
public class TwitterListsResourcesServicesImpl implements ListsResources {
    /**
     * Logger for this services
     */
    private static Logger LOGGER = LogManager.getLogger(TwitterListsResourcesServicesImpl.class.getName());
